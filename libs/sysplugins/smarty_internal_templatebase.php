...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
     ...
     *
     * @api  Smarty::isCached()
     * @link http://www.smarty.net/docs/en/api.is.cached.templates
     *
     ...
     * @link http://www.smarty.net/docs/en/api.register.plugin.templates
     *
     ...
     * @link http://www.smarty.net/docs/en/api.load.filter.templates
     *
     ...
     * @link http://www.smarty.net/docs/en/api.register.filter.templates
     *
     * @param  string      $type filter type
     ...
     * @link http://www.smarty.net/docs/en/api.register.object.templates
     *
